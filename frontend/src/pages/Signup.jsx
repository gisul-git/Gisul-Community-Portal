...
export default function Signup({ onSignupSuccess }) {
  ...
  // Track touched states for styling feedback
  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 flex w-full max-w-7xl h-full items-center justify-center lg:justify-between px-6 lg:gap-16">
        ...
        {/* --- LEFT SIDE: VISUALS (Join Community) --- */}
        {/* --- LEFT SIDE: VISUALS (Join Community) --- */}
        <div className="hidden lg:flex flex-col w-1/2 justify-center items-center h-full relative z-20">
          ...
          <div className="w-full flex flex-col items-center justify-center relative mb-8">
            ...
            <div className="relative text-center">
              ...
              >
                {/* 'Join' - CHANGED to match Login Gradient */}
                <span className="relative inline-block text-7xl font-black tracking-tighter">
                  ...
                  {/* Star - CHANGED to Indigo to match text */}
                  <Sparkles className="absolute -top-1 -right-8 w-8 h-8 text-indigo-400 animate-pulse" />
                </span>
                
                {/* 'Community' */}
                <span className="text-5xl mt-[-8px] text-slate-800 font-bold tracking-tight">
                  Community
                </span>
              </motion.h1>
              ...
              <motion.p 
                ...
                className="mt-6 text-sm font-bold tracking-[0.2em] uppercase text-slate-500"
              >
          ...
          <div className="relative w-full max-w-lg max-h-[45vh] flex items-center justify-center">
            {/* Background Glow */}
            <div className="absolute -inset-10 bg-gradient-to-tr from-indigo-500/20 via-transparent to-purple-500/20 rounded-full blur-3xl"></div>
